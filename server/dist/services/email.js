 ...
 */
export async function sendEmail({ to, subject, body, ticketNumber, inReplyTo, }) {
    const isSendGridConfigured = config.SENDGRID_API_KEY && config.SENDGRID_API_KEY !== 'your-sendgrid-api-key-here';
